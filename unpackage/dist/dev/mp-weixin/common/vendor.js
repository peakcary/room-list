...
const pages = [
  ...
  {
    path: "pages/room-edit/room-edit",
    style: {
      navigationBarTitleText: "编辑房间"
    }
  },
  {
    path: "pages/tenant-info/tenant-info",
    style: {
      navigationBarTitleText: "租户信息"
    }
  },
  {
    path: "pages/utility-record/utility-record",
    style: {
      navigationBarTitleText: "水电记录"
    }
  },
  {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.2.23"],"servePort":7001,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"pang-0217","spaceId":"mp-82beb92d-779d-44d1-a1d3-7fee8609024d","clientSecret":"950wKtihe/ZN9Q4B8lYudg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__EFF647A";
} catch (e2) {
