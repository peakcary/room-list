...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "6a4027ce-3-" + i0 + "-" + i1 + "," + ("6a4027ce-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "6a4027ce-2-" + i0 + "-" + i1 + "," + ("6a4027ce-1-" + i0)
          };
        }),
        b: "6a4027ce-1-" + i0 + ",6a4027ce-0",
        c: "6a4027ce-4-" + i0 + ",6a4027ce-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "6a4027ce-0"),
