  ...
  methods: {
    ...
    async loadRoomInfo() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/tenant-info/tenant-info.vue:224", "加载房间信息失败:", error);
        common_vendor.index.showToast({
          title: "加载失败",
          icon: "none"
        });
    ...
    async saveTenant() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/tenant-info/tenant-info.vue:405", "保存租户信息失败:", error);
        common_vendor.index.showToast({
          title: "保存失败",
          icon: "none"
        });
